...
/*
 * Extracted from Dopamine BaseBin/libjailbreak/src/main.c jbclient_initialize_primitives_internal.
 * CHANGES_FROM_REFERENCE: omit libjailbreak_IOSurface_primitives_init() call.
 * REASON: Dopamine primitives_IOSurface.m @available(iOS 16.0, *) branch intentionally
 *         skips kalloc assignment; tvOS 16.5 boomerang physrw_pte path does not require
 *         IOSurface-backed kalloc. No IOSurface stub — dependency removed at source level.
 */
